        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="card p-6">
            ...
            <div className="space-y-3 text-sm">
              {[
                { label: 'Autenticación JWT', status: '✓ Activa', cls: 'text-green-400' },
                { label: 'Control de Roles (RBAC)', status: '✓ Activo', cls: 'text-green-400' },
                { label: 'Auditoría de eventos', status: '✓ Activa', cls: 'text-green-400' },
                { label: 'Autenticación MFA', status: 'Disponible', cls: 'text-yellow-400' },
                { label: 'Rate limiting', status: '✓ 100 req/min', cls: 'text-green-400' },
              ].map((item) => (
          ...
          <div className="card p-6">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between"><span className="text-slate-400">Motor</span><span className="text-white">PostgreSQL 16</span></div>
              <div className="flex justify-between"><span className="text-slate-400">Cache</span><span className="text-white">Redis 7</span></div>
              <div className="flex justify-between"><span className="text-slate-400">ORM</span><span className="text-white">Prisma 5</span></div>
              <div className="flex justify-between"><span className="text-slate-400">Host</span><span className="text-white">postgres:5432</span></div>
            </div>
