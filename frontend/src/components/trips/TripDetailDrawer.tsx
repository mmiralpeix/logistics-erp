        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {isLoading ? (
            ...
            <div className="space-y-6">
              {/* Route Summary Card */}
              <div className="p-5 rounded-2xl shadow-md bg-gradient-to-r from-slate-900 to-blue-950 space-y-3">
